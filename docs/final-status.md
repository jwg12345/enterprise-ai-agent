...
브라우저 도구의 초기화 ACL 오류는 지속됐지만, 2026-09-08 사용자가 제공한 실제 화면 3장으로 캡처를 보완했습니다. LLM 답변과 검색 원문, 승인 요청 전 AI 초안, 티켓 생성 완료 화면을 README와 [시연 문서](portfolio-demo.md)에 연결했습니다. 캡처·문서 후속 커밋의 원격 게시와 CI는 기존 c0aaaf3 검증과 구분합니다.
