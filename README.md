...
초기 질문 임베딩에 41.6초가 걸리는 사례와 60초 timeout을 관측했습니다. 단계 로그로 임베딩 구간을 확인하고 기동 워밍업을 추가했습니다. 적용 후 한 번의 8건 실행은 첫 요청 11.2초, 이후 1.9~7.3초였습니다. 비교 환경을 통제하지 않아 워밍업 단독 개선율이나 p95/SLA를 주장하지 않습니다.

소규모 합성 문서 2개·4개 chunk의 시연이며 실제 기업 환경의 효과나 일반적인 정확도를 의미하지 않습니다. 원문을 확장한 초안 표현이 관측돼 사람 검토가 필요합니다.
